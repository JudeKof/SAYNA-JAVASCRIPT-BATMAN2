...
function changeValue() {
    if (i <= questions.length) {
        ...
        if (i === 0) {
            ...
            image.src = '/Assets/Illustrations_bat2/Batgame_4.png';
        } else if (i === 2) {
            image.src = '/Assets/Illustrations_bat2/Batgame_5.png';
        } else if (i === 3) {
            image.src = '/Assets/Illustrations_bat2/Batgame_6.png';
        } else if (i === 4) {
            image.src = '/Assets/Illustrations_bat2/Batgame_7.png';
        } else if (i === 5) {
            image.src = './Assets/Illustrations_bat2/Batgame_8.png';
        } else if (i === 6) {
            image.src = '/Assets/Illustrations_bat2/Batgame_10.png';
        } else if (i === 7) {
            image.src = '/Assets/Illustrations_bat2/Batgame_11.png';
        } else if (i === 8) {
            image.src = '/Assets/Illustrations_bat2/Batgame_12.png';
        } else if (i === 9) {
            image.src = '/Assets/Illustrations_bat2/Batgame_14.png';
        }
        else if (i === 10) {
            image.src = '/Assets/Illustrations_bat2/Batgame_17.png';
        }
        else if (i === 11) {
            image.src = '/Assets/Illustrations_bat2/Batgame_18.png';
        }
        else if (i === 12) {
            image.src = '/Assets/Illustrations_bat2/Batgame_19.png';
        }
        else if (i === 13) {
            image.src = '/Assets/Illustrations_bat2/Batgame_20.png';
        }
        else if (i === 14) {
            image.src = '/Assets/Illustrations_bat2/Batgame_21.png';
        }
